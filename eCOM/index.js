...
async function main() {
    await mongoose.connect('mongodb+srv://yash:yash23@cluster0.zacjm.mongodb.net/ShopDB?retryWrites=true&w=majority',
    {
...
app.use(session({secret: 'mysct',saveUninitialized:false,resave:false},));
